...
import {
  ...
  SiMongodb,
  SiExpress,
  SiTypescript, SiRedux, SiFirebase, SiVuedotjs, SiNodedotjs,

} from "react-icons/si";
import { GrCode } from "react-icons/gr";
import {DiReact} from "react-icons/all.js";
          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<SiVuedotjs />} name={"Vue Js"} value={75} />
                <ProgressBar logo={<SiNodedotjs />} name={"Node Js"} value={80} />
                <ProgressBar logo={<SiRedux />} name={"Redux Toolkit"} value={80} />
                <ProgressBar logo={<SiJavascript />} name={"Javascript"} value={92}/>
                <ProgressBar logo={<SiTypescript />} name={"Typescript"} value={90}/>
          ...
          <div className="right relative flex-1 flex flex-wrap p-5 gap-10 items-center justify-center sm:w-full">
            <div className="first2 flex flex-col gap-10">
              ...
              <SkillBox
                  className=""
                  logo={
                    <SiFirebase className=" text-white bg-black rounded-full h-fit border-white overflow-hidden" />
                  }
                  black={"black"}
                  white={"white"}
                  skill={"Firebase"}
            ...
            <div className="last2 flex flex-col gap-10">
              ...
              />
               ...
               <SkillBox
                className=""
                logo={
                  <SiRedux className=" text-white bg-black rounded-full h-fit border-white overflow-hidden" />
                }
                black={"black"}
                white={"white"}
                skill={"Redux"}
